document.addEventListener('DOMContentLoaded', async function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function abrirVistaParcialEditarEmpleado(empleadoId) {
            fetch(`${apiUrl}/api/Despacho/Obtener/${empleadoId}`)
        ...
        function buscarEmpleados() {
            ...
            fetch(`${apiUrl}/api/Despacho/BuscarEmpleados`, {
                method: 'POST',
                headers: {
    ...
    document.querySelectorAll('.btnEditar').forEach(btn => {
        btn.addEventListener('click', async function () {
            ...
            try {
                ...
                const response = await axios.get(`${apiUrl}/api/Despacho/Obtener/${empleadoId}`);
